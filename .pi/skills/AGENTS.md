...
| `faq-mine/SKILL.md` | Skill (v2.0): mine `docs/faq.md` from docs (README.md + `docs/*.md`) AND pi-hermes memory stores (runtime problems). → see `faq-mine/SKILL.md.AGENTS.md` |
