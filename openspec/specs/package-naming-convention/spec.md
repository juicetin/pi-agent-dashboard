...
Map each first-party `@blackbelt-technology` package kind to a deterministic npm name shape, so the name alone disambiguates dashboard plugin from pi extension.
