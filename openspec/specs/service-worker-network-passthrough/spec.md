# service-worker-network-passthrough Specification

## Purpose

Ensure the PWA service worker does not intercept or fabricate responses for API requests. API traffic passes through to the network unchanged, and failures surface as real fetch rejections rather than synthetic offline pages.
