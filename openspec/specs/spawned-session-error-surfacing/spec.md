# spawned-session-error-surfacing Specification

## Purpose
TBD - created by archiving change fix-gemini-subagent-silent-tool-schema-failure. Update Purpose after archive.
## Requirements
